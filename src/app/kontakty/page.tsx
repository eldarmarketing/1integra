        ...
        <div className={W}>
          <div data-r="reveal" className="grid md:grid-cols-3 gap-5 md:gap-6">
            ...
            <a href="mailto:info@1integra.ru"
              className="group rounded-2xl bg-white border border-gray-200 p-7 md:p-9 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
              ...
              <div className="font-heading font-bold text-lg text-gray-900 mb-2">Электронная почта</div>
              <p className="text-sm text-gray-500 mb-5">Напишите — ответим в течение часа в рабочее время</p>
            ...
            <a href="tel:+7XXXXXXXXXX"
              className="group rounded-2xl bg-white border border-gray-200 p-7 md:p-9 hover:shadow-lg hover:border-emerald-200 transition-all duration-300">
              ...
              <div className="font-heading font-bold text-lg text-gray-900 mb-2">Телефон</div>
              <p className="text-sm text-gray-500 mb-5">Пн–Пт, 09:00–18:00 по Москве</p>
              <span className="text-base font-semibold text-navy group-hover:text-navy-light transition-colors duration-200">
                +7 (XXX) XXX-XX-XX
              </span>
            </a>
            ...
            <a href="https://t.me/integra1c" target="_blank" rel="noopener noreferrer"
              className="group rounded-2xl bg-white border border-gray-200 p-7 md:p-9 hover:shadow-lg hover:border-violet-200 transition-all duration-300">
              ...
              <div className="font-heading font-bold text-lg text-gray-900 mb-2">Telegram</div>
              <p className="text-sm text-gray-500 mb-5">Быстрая связь — напишите в любое время</p>
              <span className="text-base font-semibold text-navy group-hover:text-navy-light transition-colors duration-200">
                @integra1c
              </span>
            </a>
