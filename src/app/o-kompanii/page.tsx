...
export default function AboutPage() {
  return (
    <RevealProvider>
      ...
      <section className="pt-8 pb-8 md:pt-16 md:pb-14">
        <div className={W}>
          <div className="max-w-3xl">
            ...
            <div data-r="reveal d1" className="mt-5 md:mt-7 space-y-4">
              <p className="md3-body-large text-on-surface-variant leading-[1.7]">
      ...
      {/* Для кого */}
      <section className="pt-6 pb-12 md:pt-10 md:pb-24">
        <div className={W}>
          <div data-r="reveal" className="bg-inverse-surface rounded-[var(--radius-xl)] p-8 md:p-12 lg:p-14">
            <h2 className="font-heading font-bold md3-headline-medium text-inverse-on-surface leading-[1.2] mb-6 md:mb-8">
              Для кого
            </h2>
            <div className="grid md:grid-cols-2 gap-4 md:gap-5 mb-8 md:mb-10">
              <div className="rounded-[var(--radius-lg)] bg-white/5 border border-white/10 p-6 md:p-8">
                <p className="md3-body-large text-inverse-on-surface/65 leading-[1.7]">
            ...
            <p className="font-heading font-bold text-[20px] md:text-[26px] text-inverse-on-surface leading-[1.3]">
      ...
      <section className="pt-12 pb-12 md:pt-24 md:pb-24">
        <div className={W}>
          ...
          <div data-r="reveal d1" className="max-w-3xl space-y-4 mb-10 md:mb-14">
            <p className="md3-body-large text-on-surface-variant leading-[1.7]">
          ...
          <div data-r="reveal d3" className="mt-6 md:mt-8 rounded-[var(--radius-md)] bg-primary-container/30 border border-outline-variant/30 p-6 md:p-8">
            <p className="md3-body-large text-on-surface leading-[1.7] max-w-3xl">
      ...
      <section className="pt-12 pb-12 md:pt-24 md:pb-24">
        <div className={W}>
          ...
          <p data-r="reveal d1" className="md3-body-large text-on-surface-variant leading-[1.7] mb-10 md:mb-14 max-w-3xl">
          ...
          <div data-r="reveal d2" className="grid md:grid-cols-3 gap-4 md:gap-5">
            {[
              ...
              <div key={c.n} className="bg-surface-container-lowest border border-outline-variant/50 rounded-[var(--radius-lg)] p-7 md:p-10 hover:bg-surface-container-low transition-all ease-[cubic-bezier(0.2,0,0,1)] duration-300">
                ...
                <p className="md3-body-medium text-on-surface-variant leading-[1.7]">{c.d}</p>
              </div>
            ))}
          </div>

          <div data-r="reveal d3" className="mt-6 md:mt-8 rounded-[var(--radius-md)] bg-tertiary-container border border-outline-variant/30 p-6 md:p-8 flex items-start gap-4">
            <div className="w-9 h-9 rounded-[var(--radius-sm)] flex items-center justify-center shrink-0 mt-0.5">
            ...
            <p className="md3-body-medium font-medium text-on-tertiary-container leading-[1.7]">
      ...
      <section className="pt-12 pb-12 md:pt-24 md:pb-24">
        <div className={W}>
          ...
          <div data-r="reveal d2" className="max-w-3xl space-y-4 mb-10 md:mb-14">
            <p className="md3-body-large text-on-surface-variant leading-[1.7]">
          ...
          <div data-r="reveal d3" className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {[
              ...
              <div key={s.step} className="bg-surface-container-lowest border border-outline-variant/50 rounded-[var(--radius-lg)] p-6 md:p-9 hover:bg-surface-container-low transition-all ease-[cubic-bezier(0.2,0,0,1)] duration-300">
                <div className="w-10 h-10 rounded-[var(--radius-md)] bg-primary-container flex items-center justify-center text-on-primary-container text-[11px] font-bold mb-5 md:mb-6">
                  {s.step}
                </div>
                <h3 className="font-heading font-bold md3-title-medium text-on-surface mb-2.5">{s.title}</h3>
                <p className="md3-body-small text-on-surface-variant leading-[1.7]">{s.desc}</p>
              </div>
            ))}
          </div>

          <div data-r="reveal d4" className="mt-6 md:mt-8 rounded-[var(--radius-md)] bg-tertiary-container border border-outline-variant/30 p-6 flex items-center gap-4">
        ...
        <div className={W}>
          ...
          <div data-r="reveal d1" className="grid md:grid-cols-2 gap-4 md:gap-5">
            <div className="bg-surface-container-lowest border border-outline-variant/50 rounded-[var(--radius-lg)] p-7 md:p-10 hover:bg-surface-container-low transition-all ease-[cubic-bezier(0.2,0,0,1)] duration-300">
              ...
              <p className="md3-body-large text-on-surface-variant leading-[1.7] mb-6 md:mb-8">
            ...
            <div className="bg-inverse-surface rounded-[var(--radius-lg)] p-7 md:p-12">
              ...
              <p className="md3-body-large text-inverse-on-surface/65 leading-[1.7] mb-3">
                Вы не&nbsp;платите ничего, пока система не&nbsp;заработает. Ноль до&nbsp;старта,
                ноль в&nbsp;процессе, ноль на&nbsp;сдаче.
              </p>
              <p className="md3-body-large text-inverse-on-surface/65 leading-[1.7] mb-6 md:mb-8">
          ...
          <p data-r="reveal d2" className="md3-body-large text-on-surface-variant leading-[1.7] mt-6 md:mt-8 max-w-3xl">
