    ...
    <div ref={pg}>
      ...
      <section className="py-16 md:py-28">
        <div className={W}>
          ...
          <div data-r="reveal d1" className="grid md:grid-cols-2 gap-5 md:gap-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-navy p-9 md:p-12">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-transparent to-indigo-900/30" />
              <div className="relative">
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 border border-white/10 text-xs font-medium text-white/70 mb-8">У нас</div>
      ...
      <section className="py-16 md:py-28">
        <div className={W}>
          ...
          <div data-r="reveal d2" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {[
              ...
              <div key={s.step} className="rounded-2xl bg-white border border-gray-200 p-7 md:p-9 hover:shadow-lg hover:border-gray-300 transition-all duration-300">
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${s.gradient} flex items-center justify-center text-white text-xs font-bold mb-6`}>
                  {s.step}
                </div>
          ...
          <div data-r="reveal d3" className="mt-10 rounded-2xl bg-amber-50 border border-amber-200/60 p-6 flex items-center gap-3">
