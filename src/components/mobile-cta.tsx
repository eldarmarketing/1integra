  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-surface-container-lowest/95 backdrop-blur-xl border-t border-outline-variant/30 px-4 py-3 safe-area-pb">
      <div className="flex items-center gap-2">
        ...
        <a
          href="https://t.me/integra1c"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-12 h-12 rounded-full bg-surface-container text-primary shrink-0 active:bg-surface-container-high"
          aria-label="Telegram"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <Link
          href="/kontakty"
          className="flex-1 flex items-center justify-center h-12 rounded-full bg-primary text-on-primary text-[15px] font-semibold
